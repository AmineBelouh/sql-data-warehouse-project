...
BEGIN
    ...
    SELECT
        ...
        sls_prd_key,
        sls_cust_id,
        CASE WHEN sls_order_dt = 0 OR LENGTH(sls_order_dt::TEXT) != 8 THEN NULL ELSE sls_order_dt::TEXT::DATE END AS sls_order_dt,
        CASE WHEN sls_ship_dt = 0 OR LENGTH(sls_ship_dt::TEXT) != 8 THEN NULL ELSE sls_ship_dt::TEXT::DATE END AS sls_ship_dt,
        CASE WHEN sls_due_dt = 0 OR LENGTH(sls_due_dt::TEXT) != 8 THEN NULL ELSE sls_due_dt::TEXT::DATE END AS sls_due_dt,
    ...
    SELECT
        CASE WHEN cid LIKE 'NAS%' THEN SUBSTRING(cid, 4, LENGTH(cid)) ELSE cid END AS cid, -- Remove 'NAS' prefix if present
        CASE WHEN bdate > NOW() THEN NULL ELSE bdate END AS bdate, -- Set future birthdates to NULL
